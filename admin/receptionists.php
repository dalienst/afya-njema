<?php
include("connect.php");
$q = "SELECT * FROM receptionists ORDER BY id DESC";
$result = $con->query($q);
$con->close();
?>
...
<html>
    ...
    <body>
        ...
        <div class="main">
            ...
            <section class="home">
                <!--Page heading-->
                <h1 class="h3 mb-4 text-gray-800">Receptionist Management</h1>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <div class="row">
                            <div class="col">
                                <h6 class="m-0 font-weight-bold text-danger">Receptionist List</h6>
                            </div>
