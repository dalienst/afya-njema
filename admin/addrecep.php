...
$gender=$_POST['gender'];
$sq=("insert into receptionists(fullname,email,contact,password,cpassword,gender) values('$name','$email','$phone','$password','$cpassword','$gender')");
if($sq)
{
...
<html>
    ...
    <body>
        <div class="card">
            ...
            <hr>
            <div class="card-body">
                <form action="addrecep.php" method="POST">
                    <div class="row g-3">
                        <div class="col-md-6">
